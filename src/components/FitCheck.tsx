...
/* "Read this before you apply" — the two honest lists.
   ...
   Everything in both lists is a restatement of how the client-side pages
   already say the work runs — small team, weekly demo in front of the buyer,
   engineers asked what to build. Nothing here is a new claim, so nothing here
   is flagged. */
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
        <SectionHeading
          ...
          lead="We tell clients on the first call when they should hire somebody else. It would be strange to be less honest with the people who would do the work."
          className="max-w-2xl"
        >
          ...
          >
            <div className="flex h-full flex-col rounded-[1.5rem] border border-dashed border-border bg-background p-8 sm:p-10">
              ...
              <p className="mt-8 border-t border-border pt-6 text-[13px] leading-[1.7] text-muted-foreground">
                None of these are character flaws. They are descriptions of a
                different job, and there are good ones — we would rather you
                found yours than spent a year in ours.
              </p>
            </div>
          </div>
        </div>
